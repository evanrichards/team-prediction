...
export default function IndexPage() {
  return (
    <Layout pageTitle={''}>
      <article className="prose prose-invert text-text">
        <h1 className="text-text">Welcome to Team Prediction</h1>
        <p>
        ...
        <h2 className="text-text">Optional anonymous participation</h2>
        <p>
        ...
        <h2 className="text-text">Get started today</h2>
        <p>
          Sign up for Team Prediction and start making better, more informed
          decisions. Our platform is easy to use and provides a fun and engaging
          way for employees to participate in the decision-making process.
        </p>
      </article>
    </Layout>
  );
